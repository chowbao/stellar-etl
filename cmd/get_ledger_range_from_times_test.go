...
func TestConvertTimes(t *testing.T) {
	tests := []CliTest{
		...
		{
			Name:    "normal range",
			Args:    []string{"get_ledger_range_from_times", "-s", "2016-11-10T18:00:00-05:00", "-e", "2019-09-13T23:00:00+00:00", "-o", GotTestDir(t, "normal_range.json")},
			Golden:  "normal_range.golden",
			WantErr: nil,
		},
		{
			Name:    "start too early",
			Args:    []string{"get_ledger_range_from_times", "-s", "2006-11-10T18:00:00-05:00", "-e", "2019-09-13T23:00:00+00:00", "-o", GotTestDir(t, "early_start.json")},
		...
		{
			Name:    "end too early",
			Args:    []string{"get_ledger_range_from_times", "-s", "2006-11-10T12:14:32+04:00", "-e", "2006-11-10T12:14:32+04:00", "-o", GotTestDir(t, "early_end.json")},
			Golden:  "early_end.golden",
			WantErr: nil,
		},
		{
			Name:    "same date",
			Args:    []string{"get_ledger_range_from_times", "-s", "2016-11-10T18:03:37-05:00", "-e", "2016-11-10T18:03:37-05:00", "-o", GotTestDir(t, "same_date.json")},
			Golden:  "same_date.golden",
			WantErr: nil,
		},
		{
			Name:    "checkpoint range (22343680-22343743)",
			Args:    []string{"get_ledger_range_from_times", "-s", "2019-02-06T09:14:43+00:00", "-e", "2019-02-06T09:20:23+00:00", "-o", GotTestDir(t, "checkpoint_range.json")},
			Golden:  "checkpoint_range.golden",
			WantErr: nil,
		},
		{
			Name:    "checkpoint range (9341-9401)",
			Args:    []string{"get_ledger_range_from_times", "-s", "2015-10-01T06:20:00+00:00", "-e", "2015-10-01T06:25:00+00:00", "-o", GotTestDir(t, "checkpoint_range2.json")},
			Golden:  "checkpoint_range2.golden",
			WantErr: nil,
		},
		{
			Name:    "infinite loop; checkpoint range (14558-14606)",
			Args:    []string{"get_ledger_range_from_times", "-s", "2015-10-01T13:35:00+00:00", "-e", "2015-10-01T13:40:00+00:00", "-o", GotTestDir(t, "checkpoint_range3.json")},
			Golden:  "checkpoint_range3.golden",
			WantErr: nil,
		},
		{
			Name:    "early checkpoint range (3-3)",
			Args:    []string{"get_ledger_range_from_times", "-s", "2015-09-30T16:50:00+00:00", "-e", "2015-09-30T16:55:00+00:00", "-o", GotTestDir(t, "early_checkpoint_range.json")},
