...
func (cso ConfigSettingOutput) ToParquet() interface{} {
	...
	return ConfigSettingOutputParquet{
		...
		LedgerMaxDiskReadEntries:               int64(cso.LedgerMaxDiskReadEntries),
		LedgerMaxReadBytes:                     int64(cso.LedgerMaxReadBytes),
		LedgerMaxDiskReadBytes:                 int64(cso.LedgerMaxDiskReadBytes),
		...
		TxMaxDiskReadEntries:                   int64(cso.TxMaxDiskReadEntries),
		...
		FeeWrite1Kb:                            cso.FeeWrite1Kb,
		FeeDiskRead1Kb:                         cso.FeeDiskRead1Kb,
		BucketListTargetSizeBytes:              cso.BucketListTargetSizeBytes,
		SorobanStateTargetSizeBytes:            cso.SorobanStateTargetSizeBytes,
		WriteFee1KbBucketListLow:               cso.WriteFee1KbBucketListLow,
		RentFee1KBSorobanStateSizeLow:          cso.RentFee1KBSorobanStateSizeLow,
		WriteFee1KbBucketListHigh:              cso.WriteFee1KbBucketListHigh,
		RentFee1KBSorobanStateSizeHigh:         cso.RentFee1KBSorobanStateSizeHigh,
		BucketListWriteFeeGrowthFactor:         int64(cso.BucketListWriteFeeGrowthFactor),
		SorobanStateRentFeeGrowthFactor:        int64(cso.SorobanStateRentFeeGrowthFactor),
		...
		LiveSorobanStateSizeWindowSampleSize:   int64(cso.LiveSorobanStateSizeWindowSampleSize),
		LiveSorobanStateSizeWindowSamplePeriod: int64(cso.LiveSorobanStateSizeWindowSamplePeriod),
